...
class ChartFramework {
  ...
  async renderChart(containerId, data, options = {}) {
    ...
    if (!canvas) {
      ...
      console.log(`📊 Created canvas for ${containerId}`);
    }
    ...
    try {
      ...
      console.log(`✅ Chart rendered: ${containerId} (${chartType})`);
      return chart;
  ...
  renderSparkline(containerId, data, color = '#007bff') {
    ...
    console.log(`🎨 Sparkline data for ${containerId}:`, {
      color,
...
document.addEventListener('DOMContentLoaded', () => {
  console.log('📊 Chart Framework initialized');
});
